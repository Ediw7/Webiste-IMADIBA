    ...
    <div className="min-h-screen">
      ...
      <section className="bg-blue-900 py-20 text-white rounded-lg" data-aos="fade-down">
        <div className="container mx-auto px-4 rounded-lg">
          <h1 className="text-4xl font-bold mb-4 text-center">DIMAS</h1>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-4" data-aos="fade-up">
          ...
          <div className="flex flex-col md:flex-row justify-center items-center gap-8 mb-12" data-aos="zoom-in">
            {[
              { name: 'Multazzam Arrosyid', position: 'Kepala Bidang', description: 'Teknik Sipil Arsitektur 2022', igLink: 'https://www.instagram.com/multazamar/', image: '' },
              { name: 'gatau', position: 'Wakil Kepala Bidang', description: 'gatau', igLink: '', image: '' },
            ].map((member, index) => (
          ...
          <div className="mb-16" data-aos="fade-up">
           ...
           <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
              {[
                { title: 'IMADIBA mengisi Kemerdekaan', description: 'deskripsi' },
                { title: 'Sosial project', description: 'deskripsi'},
                { title: 'Smartimotion 7.0', description: 'deskripsi'},
              ].map((program, index) => (
